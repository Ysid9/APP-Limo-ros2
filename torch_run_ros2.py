...
if choice.lower() == 'y':
    try:
        with open('last_w_torch_mecanum.json') as fp:
            json_obj = json.load(fp)
        network.load_weights_from_json(json_obj)
        print("Weights loaded from last_w_torch_mecanum.json")
    except FileNotFoundError:
        print("No weight file found (last_w_torch_mecanum.json), starting with random weights.")
...
if save_choice.lower() == 'y':
    ...
    with open('last_w_torch_mecanum.json', 'w') as fp:
        json.dump(json_obj, fp)
    print("Weights saved to last_w_torch_mecanum.json")
else:
